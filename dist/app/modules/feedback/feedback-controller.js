...
const createFeedback = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const user = req.user;
    const result = yield feedback_service_1.FeedbackService.createFeedback(Object.assign(Object.assign({}, FeedbackData), { userId: user === null || user === void 0 ? void 0 : user.userId }));
